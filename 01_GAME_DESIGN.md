...
Параметры plot-сессии:

- максимум 6 игроков на сервер;
- 6 участков `plot_01` … `plot_06`;
- сетка 3 × 2;
- участок 96 × 96 studs с высотой строительства 64 studs;
- расстояние между центрами 128 studs и свободный gap 32 studs.
